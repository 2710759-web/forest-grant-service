...
with col1:
    ...
    if not filtered_df.empty:
        ...
        # 1. Добавляем фоновое изображение
        ...
        # 2. Подготовка текста для всплывающих подсказок (самый надежный способ)
        hover_texts = []
        ...
        fig.add_trace(go.Scatter(
            ...
            text=hover_texts,      # Передаем подготовленный текст
            hoverinfo='text',      # Указываем показывать только этот текст
            name='Деревья'
        ))
